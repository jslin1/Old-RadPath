function Register2(prefix, makefile, n_cores, fixed_series, moving_series, apply_series)
...
for ii=1:size(moving_series,1)
    ...
    fprintf(fid,['\t$(ANTSPATH)/ResampleImageBySpacing 3 '...
        prefix '00_radpath_raw/radpath_raw_' m_ptno_Descrip_UID '.nii.gz '...
    ...
    fprintf(fid,['\t$(ANTSPATH)/ImageMath 3 '...
        ...
        'Laplacian '...
        prefix '00_radpath_raw/radpath_raw_' m_ptno_Descrip_UID '.nii.gz 1.5 1\n']);
    ...
    fprintf(fid,['\t$(ANTSPATH)/antsRegistration -d 3 -u 1 -w [0.025, 0.975] '...
        ...
        '-m MI[' script01_prefix '01_N4/N4_' f_ptno_Descrip_UID '.nii.gz,'...
              prefix '00_radpath_raw/radpath_raw_' m_ptno_Descrip_UID '.nii.gz,1,32,Regular,0.25] -c [1000x500x250x100,1e-8,10] -t Rigid[0.1] -f 8x4x2x1 -s 4x2x1x0 '...
        '-m MI[' script01_prefix '01_N4/N4_' f_ptno_Descrip_UID '.nii.gz,'...
              prefix '00_radpath_raw/radpath_raw_' m_ptno_Descrip_UID '.nii.gz,1,32,Regular,0.25] -c [1000x500x250x100,1e-8,10] -t Affine[0.1] -f 8x4x2x1 -s 4x2x1x0 '...
    ...
    for jj = a_study'
        ...
        fprintf(fid,['\t$(ANTSPATH)/antsApplyTransforms -d 3 '...
                    '-i ' prefix '00_radpath_raw/radpath_raw_' a_ptno_Descrip_UID '.nii.gz '...
