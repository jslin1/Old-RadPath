...
cf_orig = file.img(unique(cf_sample))*conv_factor; % Original Rez
...
cf_high = file.img(cf_sample)*conv_factor; % High Rez
...
sph_orig = file.img(unique(sph_sample))*conv_factor; % Original Rez
...
sph_high = file.img(sph_sample)*conv_factor; % High Rez
