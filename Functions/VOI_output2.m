function  VOI_output2(conv_factor, temp_series, rez, ptno, site,  voi_cell1, voi_cell2, voi_idx1, voi_idx2, zz)
    ...
    if rez == 1
        img = load_nii([script02_prefix '10_Warped/Warped_' ptno '_' site '_' Descrip_UID '.nii.gz']); 
    elseif rez == 2
